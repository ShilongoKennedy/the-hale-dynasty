...
(function () {
  ...
  var SYSTEM_PROMPT = [
    ...
    '',
    'VOLUME VI: THE HALE ENTAIL (1795–1835). The Regency. Augusta Hale manages the estate alone with extraordinary practical intelligence. Key documents include her accounts, letters, and entail papers. Known lines include: "The wood is worth more standing" and "The old apple tree by the wall — I believe it was here before my time and before my mother\'s time. It still bears."',
    '',
    'VOLUME VII: THE CORRESPONDENCE OF MR EDMUND HALE (1868–1882). High Victorian. Edmund Hale writes two letters he never sends — one to a woman named Catherine, one to his brother. The burned, unsent letters are among the most significant documents in the collection. Eleanor reconstructed one partially using multispectral imaging. Edmund sealed his letters with plain wax and no family matrix. Also: the declassification request system for restricted passages and the private arrangements discovered after his death.',
    '',
    ...
    '',
    'VOLUME IX: THE NAME (1933–1960). The Second World War. Key figure: Violet Marsh. Oral history interview recorded on cassette in 1978: "There was a cat. George. He was ginger. I never got another one." The family is displaced, bombed out, and reconstructed. The volume is named "The Name" because there is a question about what name the family should carry forward.',
    '',
    ...
    '',
    'VOL. IX · Violet Marsh, oral history · 1978: "There was a cat. George. He was ginger. I never got another one." After the bombing, the family moved to Harlow and began again there.',
    '',
    ...
    '',
    'AELSWITH (c.1045–c.1110). English widow of Halecroft who married Ranulf de la Hale in 1068. She taught him the language and customs of the estate and remains one of the most important figures in the first volume. Eleanor finds her compelling because she is one of the people who made the line legible to itself.',
    '',
  ...
  ══════════════════════════════════════════ */
  var ORACLE = [
    { label: 'Vol. I · 1068', text: '"In the spring of 1068 Ranulf de la Hale married Aelswith of Halecroft." — Brother Eadmer\'s Chronicle' },
    ...
    { label: 'Vol. VI · 1803', text: '"The fact that the law does not provide me a name for what I have done does not alter what I have done." — Augusta Hale to Mr Westbrook, Solicitor, March 1803' },
    { label: 'Vol. VII · 1882', text: 'Edmund Hale\'s sealed papers record private arrangements, unsent letters, and a declassification trail that changes how the family history is read.' },
